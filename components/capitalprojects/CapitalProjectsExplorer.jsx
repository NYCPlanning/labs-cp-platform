...
var aboutContent = (
  <div>
    ...
    <p>
    The datasets currently feeding into CAPE come from:
    </p>
      <ul type={"disc"}>
        <li>NYC Department of Design and Construction Capital Projects</li>
        <li>NYC Department of Parks and Recreation Capital Projects Tracker/li>
        <li>NYC Department of Transportation</li>
        <li>NYC Mayor’s Office of Recovery and Resiliency Projects Map</li>
        <li>NYC School Construction Authority</li>
      </ul>
    Together these data sources report over 6,000 capital projects that span over a multitude of sites.  NYC Planning’s Capital Planning Docs site contains details on CAPE’s data sources, database fields, and creation and update processes.
    </p>
