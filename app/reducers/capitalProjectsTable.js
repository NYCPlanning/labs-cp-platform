...
const initialState = {
  ...
  commitmentsSql: 'SELECT * FROM cpdb_commitments_170906',
  ...
  switch (action.type) {
    ...
    case AT.RESET_CAPITAL_PROJECTS_TABLE_FILTES:
      return Object.assign({}, state, {
        filterDimensions: getDefaultFilters(),
        sql: getTableSql(getDefaultFilters()),
        commitmentsSql: `SELECT * FROM cpdb_commitments_170906 a WHERE a.maprojid IN (SELECT b.maprojid FROM (${getTableSql(getDefaultFilters())}) b)`,
      });
    ...
    case AT.SET_CAPITAL_PROJECTS_TABLE_FILTER_DIMENSION:
      ...
      return Object.assign({}, state, {
        ...
        commitmentsSql: `SELECT * FROM cpdb_commitments_170906 a WHERE a.maprojid IN (SELECT b.maprojid FROM (${getTableSql(filterDimensions)}) b)`,
      });
