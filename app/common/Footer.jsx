          ...
          <div className="row">
            <div className="col-xs-12">
              ...
              <ul className="list-inline list-unstyled social-icons">
                <li>
                  <a href="https://github.com/nycplanning" target="_blank" rel="noopener noreferrer" className="github">
                ...
                <li>
                  <a href="http://twitter.com/nycplanning" target="_blank" rel="noopener noreferrer" className="twitter">
