//CustomTab replaces the Material-UI Tab Component, adding custom styling that the original component does not support
...
function getStyles(props, context) {
  ...
  return {
    root: {
      ...
      //insert backgroundColor for tab
      backgroundColor: props.selected ? '#808080' : '#525252',
    ...
    if (icon && React.isValidElement(icon)) {
      const iconProps = {
        style: {
          ...
          height: '40px',  //make all icons 40px in height
          lineHeight: '40px'
        },
      };
