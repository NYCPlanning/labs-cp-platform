...
var MapboxGLMap = React.createClass({
  ...
  initializeMap() {
    ...
    //this.updateBounds()
    // map.on('rotateend', this.updateBounds)
  ...
  updateBounds() {
    //hack to get corners of the map when tilted 
    //from https://github.com/mapbox/mapbox-gl-js/issues/2375
    ...
    this.props.onUpdateBounds(polygon)
  },
